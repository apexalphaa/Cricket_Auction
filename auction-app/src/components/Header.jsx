...
export default function Header() {
    ...
    return (
        <header className="bg-gradient-to-r from-auction-red to-red-900 border-b-2 border-auction-gold shadow-lg sticky top-0 z-50 safe-area-inset-top">
                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <Link to="/" className="flex items-center space-x-3">
                        <div className="relative group">
                            <img src={logo} alt="SPL Logo" className="h-12 w-12 rounded-full border-2 border-auction-gold shadow-[0_0_10px_rgba(255,215,0,0.5)] group-hover:scale-110 transition duration-300 object-cover" />
                        ...
                        {currentUser ? (
                            <>
                                <div className="hidden md:flex flex-col text-right mr-4">
                                    ...
                                    <span className="text-[10px] text-gray-500 font-mono">UID: {currentUser.uid.slice(0, 6)}...</span>
                                </div>
